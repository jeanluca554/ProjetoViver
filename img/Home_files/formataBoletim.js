                            ...
                            if (response['mensagem'] != 'erro') {
                                ...
                                else
                                {
                                    ...
                                    $.each(response, function (key, value) {
                                        ...
                                        var linha = novaLinhaTabelaAlunosDaTurma(nomeAluno, idAluno, situacao, prova1, prova2, trabalho, recuperacao, media, faltas, mediaParcial);
...
function novaLinhaTabelaAlunosDaTurma(nomeAluno, idAluno, situacao, prova1, prova2, trabalho, recuperacao, media, faltas, mediaParcial)
{
    var linha = $("<tr>");
