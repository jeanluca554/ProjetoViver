<?php 
	...
	try
	{
		$query = "	SELECT a.nome_aluno, a.id_aluno
					FROM matricula m
					INNER JOIN turma t
					ON m.id_turma = t.id_turma
					INNER JOIN aluno a
					ON m.id_aluno = a.id_aluno
					WHERE m.id_turma = $turma
				...
				<div class="principal">
					...
					?>
						<div class="container">
							...
							<div class="row ">
								<div class="col-8">
									<h5><?php echo $linha['nome_aluno'] ?></h5>
								</div>
								<div class="col ">
						...
						<table 
								class="table table-hover table-bordered table-striped tabelaBoletimPDF border border-dark mb-5" 
								id="tabelaBoletimPDF"
							>
